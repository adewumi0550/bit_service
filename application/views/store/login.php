...
<head>
    ...
    <title>Sign In:: Bitmoservice</title>
        ...
        <div class="row mh-100vh">
            ...
            <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0" id="login-block">
                ...
                <div class="border rounded-0 shadow-sm m-auto w-lg-75 w-xl-50 pb-2">
                    ...
                    <!-- End: Login form --><small class="form-text text-center text-muted">Forgot ten</small>
                    <hr class="w-75">
                    <!-- Start: Forgot password -->
                    <p class="text-center mt-3 mb-0"><a href="auth_fpswrd.html" class="text-info small mr-3">Email</a><a class="text-muted small">← your or →</a><a href="<?php echo base_url(); ?>forgot-password" class="text-info small ml-3">Password ?</a></p>
                    <!-- End: Forgot password --><small class="form-text text-center text-muted">Not registered?</small>
                    <hr>
                    <!-- Start: Forgot password -->
                    <p class="text-center mt-3 mb-0"><a href="<?php echo base_url(); ?>Signup" class="text-info small mr-3">Signup here</a></p>
