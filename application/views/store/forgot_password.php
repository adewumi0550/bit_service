...
<head>
    ...
    <title>Forgot Password:: Bitmoservice</title>
        ...
        <div class="row mh-100vh">
            ...
            <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0" id="login-block">
                ...
                <div class="border rounded-0 shadow-sm m-auto w-lg-75 w-xl-50 pb-2">
                    ...
                    <p class="text-center mt-3 mb-0"><a href="<?php echo base_url(); ?>login" class="text-info small mr-3">Login</a><a class="text-muted small">← or →</a><a href="<?php echo base_url();?>signup" class="text-info small ml-3">Signup</a></p>
