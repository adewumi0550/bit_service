            ...
            <div class="container-fluid">
                <div class="card border rounded shadow-lg" style="margin-top: .8rem;margin-bottom: .6rem;">
                    <div class="card-body">
                        ...
                        <p class="text-center">Choose a subscription plan and start rendering your service</p><small class="form-text text-info" style="font-size: 16px;"><strong>Note: </strong>The plans below allows your profile to be visible to the general public so there can see what product you are rendering, which mean a client from anywhere can request for your service. Your profile deactivates as soon as your subscription expires.</small></div>
                </div>
                                        ...
                                        <div class="border rounded shadow-lg pricing-area-1" style="background-color: #464a6c;">
                                            <div class="title-area">
                                                ...
                                                <div class="tada animated infinite price-1">
                                                    <h1><span class="after">NGN</span>1,500</h1><span class="before">Per/Mo</span></div>
                                            </div>
                                            ...
                                            <div class="price-button-1"><a href="../bs_auth/render.html?plan=basic&amp;sub=false&amp;acc=create" class="button-1">Subscribe</a></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="border rounded shadow-lg pricing-area-1" style="background-color: #464a6c;">
                                            <div class="title-area">
                                                ...
                                                <div class="rubberBand animated infinite price-1">
                                                    <h1><span class="after">NGN</span>9,000</h1><span class="before">per 6/Mo</span></div>
                                            </div>
                                            <div class="price-body-1">
                                                <ul class="sub-item-list">
                                            ...
                                            <div class="price-button-1"><a href="../bs_auth/render.html?plan=standard&amp;sub=false&amp;acc=create" class="button-1">Subscribe</a></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="border rounded shadow-lg pricing-area-1" style="background-color: #464a6c;">
                                            <div class="title-area">
                                                ...
                                                <div class="swing animated infinite price-1">
                                                    <h1><span class="after">NGN</span>18,000</h1><span class="before">per 1/yr</span></div>
                                            </div>
                                            <div class="price-body-1">
                                                <ul class="sub-item-list">
                                            ...
                                            <div class="price-button-1"><a href="../bs_auth/render.html?plan=premium&amp;sub=false&amp;acc=create" class="button-1" style="background-color: #eac70e;">Subscribe</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
